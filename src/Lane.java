...
public class Lane extends Thread implements PinsetterObserver {
     ...
     *
     * A new lane has been created and its thered is executing
     */
    public Lane() {
    ...
    public void run() {
        ...
        while (true) {
            // Inorder for a lane to run it needs to have a party assigned
            if (partyAssigned) {

                // To make throws there must be an active game
                if (!gameFinished) {
                    ...
                    while (gameIsHalted) {
                        try {
                            ...
                            System.out.println("Error halting the game.");
                        }
                    }

                    // Check if the bowler has another throw
                ...
                // The game has ended, show the end game prompt, send the scores to the control desk, and ask if the
                // bowlers would like to bowl another game
                else {
            ...
            try {
                ...
                System.out.println("Error sleeping the lane.");
            }
        }
    }
    ...
    /**
     * Add an observer to the lane so they'll be updated about changes
     * @param adding - The observer being added.
     */
    ...
    private void publish(LaneEvent event) {
